# Rule Request Backlog — 5 Dec 2025

Each section below copies the **Add Rule** issue template so we can paste it into GitHub issues when ready. All boxes remain unchecked because the pages still need to be written.
...
- [ ] Why rule exists (1 small paragraph)
- [ ] Extra notes (3–5 bullets, India-specific)
- [ ] Official source links (DGCA, airport, govt)
...
- [ ] Language: simple, honest, user-friendly
